...
void namefun()
{
	...
	double phone;
	char gender[8];
	fptr = fopen("contact.txt", "ab+"); // ab+ gives us the ability of writing the function and add the second data in the existing one...
	if (fptr == NULL)
	{
...
void searchfun()
{
	...
	fflush(stdin);
	gotoxy(18, 2);
	printf("\xDB\xDB\xDB Enter the name of the person which you want details :  ");
	gets(name1);
...
void listfun()
{
	...
	printf("\n");
	while (fscanf(fptr, "%s %s %s %s %lf", name, gender, address, gmail, &phone) != EOF)
	{
...
void deletefun()
{
	...
	system("cls");
	gotoxy(31, 4);
	printf("Enter Contact name which you want to delete: ");
	gets(name1);
	system("cls");
	while (fscanf(fptr, "%s %s %s %s %lf\n", name, address, gender, gmail, &phone) != EOF)
	{
...
void exitfun()
{
	system("cls");
	gotoxy(31, 4);
	printf("\xB2\xB2\xB2\xB2 Thank for using PhoneBook Application \xB2\xB2\xB2\xB2");
	gotoxy(31, 6);
	printf("\xB2 Sumit Soni");
	gotoxy(31, 8);
}

void password(void)
{
	char passwords[20] = {"pass"};
	gotoxy(22, 2);
	int j;
	int z;
	char name[40] = " PHONEBOOK APPLICATION ";
	z = strlen(name);
	for (j = 0; j <= 16; j++)
	{
		Sleep(50);
...
void menu()
{
	system("cls");
	gotoxy(30, 1);
	printf("\xB3\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 Wellcome Sumit \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB3");
	gotoxy(31, 4);
